...
namespace LayerTemplateEdited.API.Middleware
{
	public class MetricReporter
	{
		...
		public MetricReporter(ILogger<MetricReporter> logger) { 
			...
			_responseTimeHistogram = Metrics.CreateHistogram("request_duration_seconds", "The duration in seconds between the response to a request.", new HistogramConfiguration { Buckets = Histogram.ExponentialBuckets(0.01, 2, 10), LabelNames = new[] { "status_code", "method" } }); 
		}
